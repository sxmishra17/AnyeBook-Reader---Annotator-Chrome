# AnyeBook Reader & Annotator — Chrome Extension
...
- 📖 **Multi-Format Support** — Open and read EPUB, MOBI, AZW3, PDF, and DOCX files directly in Chrome
...
Search **"AnyeBook Reader & Annotator"** on the [Chrome Web Store](https://chrome.google.com/webstore)
...
1. Click the **AnyeBook Reader** icon in the toolbar
...
**No data leaves your device.** All file processing and storage is local. See [PRIVACY.md](./PRIVACY.md) for full details.
